...
export MJPG_VERSION=2.0.1-8~${BUILD_NUMBER}.a48d422
...
export DTC_VERSION=1.4-5~${BUILD_NUMBER}.65cc4d2
export DTC_GITHASH=65cc4d2748a2c2e6f27f1cf39e07a5dbabd80ebf
export CLOUD9_VERSION=0.7.0-5~${BUILD_NUMBER}.5b62a7c
export CLOUD9_GITHASH=5b62a7c83445ccba9f50592d41a7128b1f1fe868
export SAMBA_CONFIG_VERSION=0.2~${BUILD_NUMBER}
export EMMCCOPY_VERSION=0.1~${BUILD_NUMBER}
export AVRDUDE_VERSION=1:5.11.1-1~${BUILD_NUMBER}.ad04c42
